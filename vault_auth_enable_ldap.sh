...
vault write auth/ldap/config \
    url="ldap://ec2-35-177-59-204.eu-west-2.compute.amazonaws.com" \
...
vault secrets enable openldap ad_demo
...
vault write ad_demo/config \
   binddn="CN=vaultadmin,CN=Users,DC=hashidemos,DC=io" \
   bindpass="P@ssw0rd" \
   url="ldaps://ec2-35-177-59-204.eu-west-2.compute.amazonaws.com" \
   schema=ad \
   insecure_tls=true \
   starttls=false \
   ttl=10m
